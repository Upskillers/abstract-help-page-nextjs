...
export default function Layout({children}){
    return (
        <div className="w-full">
            <Head>
                <meta
                    name="Abstract Help Centre"
                    content="Help centre for Abstract"
                />
            </Head>
            <div className="w-full bg-[#003049] m-0 flex flex-row justify-between">

                <div id="logo-wrapper " className="pr-2 pl-32 w-auto h-16 flex p-4">
                ...
                <div className="m-auto mr-4">
                    <button type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 border border-white ">Submit a request</button>
                    <button type="button" class="text-white bg-[#669BBC] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-2 focus:outline-none border border-[#669BBC]">Sign in</button>
                </div>
            </div>
            <main>{children}</main>
