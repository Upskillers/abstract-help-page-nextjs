    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full bg-[#003049] m-0 flex flex-row justify-between">
                ...
                <div>
                    <button onClick={handleToggle} data-collapse-toggle="navbar-default" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg bg-none md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-default" aria-expanded="false">
