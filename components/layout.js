...
export default function Layout({children}){
    return (
        ...
        <div className="w-full bg-black  ">
            ...
            <div id = "logo-wrapper" className = "w-[30%] flex">
            <svg className="block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 51" preserveAspectRatio="xMinYMid slice">
                ...
                <a class="text-white" title="Home" href="/hc/en-us">Help Center</a>
            </div> 
        </div>
        <main>{children}</main>
